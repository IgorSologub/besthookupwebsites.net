...
public class Constant {
    ...
    public static class Urls {
        public static final String MAIN_PAGE_URL = "https://besthookupwebsites.net/";
        public static final String REVIEW_CATEGORY_URL = "https://besthookupwebsites.net/reviews/";
        public static final String REVIEW_CATEGORY_SECOND_PAGE_URL = "https://besthookupwebsites.net/reviews/page/2/";
        public static final String REVIEW_PAGE_URL = "https://besthookupwebsites.net/casualdates-review/";
        public static final String QUIZ_PAGE_URL = "https://besthookupwebsites.net/sugar-daddy-quiz/";
        public static final String ESCORT_PAGE_URL = "https://besthookupwebsites.net/escort/";
        public static final String BLOG_CATEGORY_URL = "https://besthookupwebsites.net/blog/";
        public static final String BLOG_PAGE_URL = "https://besthookupwebsites.net/pof-vs-match/";
        public static final String SUGAR_DADDIES_PAGE_URL = "https://besthookupwebsites.net/sugar-daddies-usa/";
        public static final String LOCAL_HOOKUP_URL = "https://besthookupwebsites.net/local-hookup/";
        public static final String CONTACT_US_PAGE_URL = "https://besthookupwebsites.net/contact-us/";
    }
    ...
    public static class Footer {
        ...
        public static final int NUMBER_OF_GOOD_FOOTER_BUTTONS = 26;
    }
